...
int main(){
    ...
    while (instructionLabalList != NULL){
        while (instructionLabalList->labal.instructionNodeList != NULL){
            ast_checker_check_instruction_sentence(&astChecker, instructionLabalList->labal.instructionNodeList->node);
            instructionLabalList->labal.instructionNodeList = instructionLabalList->labal.instructionNodeList->next;
        }
